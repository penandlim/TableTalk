        ...
        if (typeof heading !== "undefined" && heading !== null) { // && typeof orientation !== "undefined") {
            ...
            for (var i = 0; i < words.length; ++i) {
                ...
                if (typeof item.style.transform !== "undefined") {
                    ...
                    item.style.transform += "translate(0px, " + ((distance / -1.2) - (!isCloseToInteractWith * 50)) + "px)";
                    ...
                    item.style.webkitTransform += "translate(0px, " + ((distance / -1.2) - (!isCloseToInteractWith * 50))  + "px)";
                }
